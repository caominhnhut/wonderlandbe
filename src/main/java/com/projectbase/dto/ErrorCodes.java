...
public enum ErrorCodes{
    ...
    INVALID_EMAIL("400", "Email is invalid", "The user creation request contains an invalid email"),
    INVALID_PASSWORD("400", "Password is invalid", "The password must at least 8 characters,\n at least one special character \n at least one upper case."),
    PASSWORDS_NOT_MATCH("400", "Password not match", "The passwords are not match"),
